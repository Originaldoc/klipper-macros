# Customized changes for Ender-3
* Original repository: [https://github.com/jschuh/klipper-macros](https://github.com/jschuh/klipper-macros)
* Added **Power Lost Recovery** (PLR) functionality from the original project: [https://github.com/The--Captain/plr-klipper](https://github.com/The--Captain/plr-klipper)
* Added **RESUME_CANCEL** functionality over the original PLR project.
